...
**[supabase-security-audit](https://github.com/anymikey/supabase-security-audit)** — Claude Code skill that audits Supabase RLS/grants for gaps advisors miss and generates fix migrations.

**[pro-prompter](https://github.com/anymikey/pro-prompter)** — Claude Code skill that turns a vague description into a graded, execution-ready coding prompt via a 5-dimension rubric.

**[flutter-release-guard](https://github.com/anymikey/flutter-release-guard)** — Claude Code skill catching Flutter release bugs that only surface after submission: version drift, l10n correctness, iOS Privacy Manifest gaps, permission drift.
